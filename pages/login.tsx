    ...
    <div className="bg-slate-200 pt-28 pb-8">
      ...
      >
        <div className="flex flex-col gap-6">
          ...
          <button className="flex h-14 w-full items-center justify-center border-2 border-black bg-primary uppercase text-white transition-colors duration-300">login</button>
          <Link href="/">
          ...
          <div className="text-center">
            ...
            <Link href="/register">
              <a className="text-lg font-medium hover:underline">Sign Up</a>
            </Link>
          </div>
        </div>
      </form>
